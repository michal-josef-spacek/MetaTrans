...
MetaTrans::LinguaTranslateGoogle - MetaTrans plug-in for Lingua::Translate::Google
...
=item MetaTrans::LinguaTranslateGoogle->new(%options)

This method constructs a new MetaTrans::LinguaTranslateGoogle object and returns it. All
...
sub new
{
    ...
    if (! exists $options{api_key}) {
        die 'You need google api key.';
    }
    ...
    my $google = Lingua::Translate::Google->new(
        'api_key' => $options{api_key},
    );

    # add supported languages.
    foreach my $direction ($google->available)
    {
        # TODO        
    }
...
Copyright 2009-2012 Michal Špaček, All Rights Reserved.
